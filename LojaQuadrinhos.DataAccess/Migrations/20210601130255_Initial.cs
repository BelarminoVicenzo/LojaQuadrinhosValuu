    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuadrinhoGenre", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuadrinhoState", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuadrinhoStateId = table.Column<int>(type: "int", nullable: false),
                    ChapterNumbers = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quadrinho", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Quadrinho_QuadrinhoGenre_GenreId",
                        column: x => x.GenreId,
                        principalTable: "QuadrinhoGenre",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Quadrinho_QuadrinhoState_QuadrinhoStateId",
                        column: x => x.QuadrinhoStateId,
                        principalTable: "QuadrinhoState",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuadrinhoId = table.Column<int>(type: "int", nullable: false),
                    PurchaseDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    QuadrinhoId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quadrinho_GenreId",
                table: "Quadrinho",
                column: "GenreId");

            migrationBuilder.CreateIndex(
                name: "IX_Quadrinho_QuadrinhoStateId",
                table: "Quadrinho",
                column: "QuadrinhoStateId");
        }
